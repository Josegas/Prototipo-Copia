   ...
   public function recetas(Request $request)
    {
        ...
        $recetas = $this->recetaService->obtenerRecetasEmpleado($idCadena,$idSucursal, $estado);
    ...
    public function recetasExpiradas()
    {
        ...
        $recetas = $this->recetaService->obtenerRecetasExpiradas($idCadena,$idSucursal);
    ...
    {
        $ok = $this->recetaService->marcarComoLista($id);
    ...
    {
        $ok = $this->recetaService->marcarComoEntregada($id);
    ...
    public function confirmarRecetaNoRecogida(Request $request,int $idReceta)
    {
        try {
            ...
            $ok = $this->recetaService->actualizarEstado($idReceta, 'no_recogida');
